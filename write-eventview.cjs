...
type View = 'empty' | 'create' | 'dashboard' | 'settings'
...
`;
fs.writeFileSync('src/components/dashboard/EventView.tsx', content);
console.log('EventView.tsx written successfully');
</arg_value></tool_call>